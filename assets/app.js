const dict = {
  fr: {
    ...
    edu_m1_meta: "Université de Béjaïa",
    ...
    proj_2_name: "Ajoute ta prochaine quête",
    proj_2_desc: "Remplace cette carte par un autre projet : nom, lien GitHub, description et stack technique.",
    proj_2_link: "GitHub",
  ...
  en: {
    ...
    player_badge: "Active player · Full-Stack",
    hero_role: "Software Engineering Master's Student",
    hero_bio: "Software Engineering Master's student at Université de Béjaïa, passionate about web and mobile development. Currently building <strong>LetsAllGo</strong>, an e-learning platform for algorithmics, while exploring modern full-stack architectures.",
    btn_cv: "Download resume",
    btn_contact: "Contact me",
    btn_projects: "See my projects",
    stat_formation: "Education",
    stat_formation_v: "Master's — ongoing",
    stat_projets: "Shipped projects",
    ...
    edu_title: "Education",
    edu_m2_title: "Master's in Software Engineering",
    edu_m2_meta: "Université de Béjaïa",
    ...
    proj_1_desc: "Full-stack e-learning platform for algorithmics. Flutter/Dart desktop frontend, Node.js/TypeScript backend with Prisma and Supabase.",
    ...
    proj_2_name: "Add your next quest",
    proj_2_desc: "Replace this card with another project: name, GitHub link, description and tech stack.",
    proj_2_link: "GitHub",
...
function applyLang(lang){
  ...
  document.querySelectorAll("[data-i18n]").forEach(el => {
    ...
    if(dict[lang] && dict[lang][k] !== undefined) el.innerHTML = dict[lang][k];
  });
